...
class OwnerWipeAllMoney extends Command {

    public function __construct()
    {
        parent::__construct("wipeservermoney", "Wipes all money in the server", "/wipeservermoney", []);
        $this->setPermission("owner.base.frozen.economy");
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args)
    {
        ...
        Economy::clearAllMoney();
        $sender->sendMessage($prefix . "§aYou Wiped all money");
    }
}